...
const combinedHash = (first, second) => {
    ...
    return Buffer.from(utils.solidityKeccak256(['bytes32', 'bytes32'], [first, second].sort(Buffer.compare)).slice(2), 'hex');
};
...
const verifyProof = (index, account, amount, proof, root) => {
